...
def detect(df: pd.DataFrame, stage: int, pivots: dict) -> Optional[dict]:
    ...
    # Convergence: upper rises slower than lower (they squeeze together)
    ...
    # ------------------------------------------------------------------ #
    # Support = most recent trough price                                  #
    # ------------------------------------------------------------------ #
    support       = round(anchor_troughs[-1]["price"], 2)
